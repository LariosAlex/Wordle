...
$index = [
    ...
    'itemList1' => '<strong>VERDE</strong> significa que la letra R está en la palabra y en la posición <strong>CORRECTA</strong>.',
    ...
    'itemList3' => '<strong>GRIS</strong> significa que la letra <strong>NO está en la palabra</strong>.',
];
...
$fiPartida = [
    ...
    'pGuanyades' => 'Partidas ganadas: ',
    'pPerdudes' => 'Partidas perdidas: ',
    'partida' => 'Partida: ',
    'intents' => 'Intentos: ',
    'punts' => 'Puntuación: ',
